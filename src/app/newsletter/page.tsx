...
export const metadata: Metadata = {
  title: 'The AI Advantage Newsletter | Free Weekly Insights',
  description: 'Get the exact AI automation strategies that generated $47M+ in client revenue. Weekly deep dives, tactical playbooks, and early access to opportunities.',
  openGraph: {
    title: 'The AI Advantage Newsletter',
    description: 'Weekly AI strategies from the team that generated $47M+ in client revenue.',
  },
}
