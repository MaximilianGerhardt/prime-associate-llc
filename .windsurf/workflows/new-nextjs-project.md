...
Browser scrollt nicht erneut zu #hash wenn Hash bereits in URL ist. Lösung:
...
**Verwendung:** Für alle Anchor-Links (#apply, #benefits, etc.) `SmoothScrollLink` statt `Link` verwenden.
